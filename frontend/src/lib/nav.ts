...
import {
  LayoutDashboard, BookOpen, ClipboardList, ListChecks, FileQuestion, GraduationCap, CalendarCheck, Megaphone, Users, School, Building2, Settings2, ShieldCheck, Layers,
...
const keuangan: NavSection = { title: 'Keuangan', items: [
  ...
  { label: 'Pembayaran', to: 'keuangan/pembayaran', icon: Wallet, perm: 'finance:read', feature: 'finance' },
  { label: 'Jenis Biaya & Denda', to: 'keuangan/jenis-biaya', icon: Settings2, perm: 'finance:write', feature: 'finance' },
  { label: 'Rekonsiliasi Bank', to: 'keuangan/rekonsiliasi', icon: FileSpreadsheet, perm: 'finance:reconcile', feature: 'finance' },
  { label: 'Arus Kas', to: 'keuangan/arus-kas', icon: LineChart, perm: 'finance:read', feature: 'finance' },
  { label: 'Payroll', to: 'payroll', icon: Banknote, perm: 'payroll:read', feature: 'payroll' },
  { label: 'Slip Gaji Saya', to: 'payroll/slip', icon: Banknote, perm: 'payroll:slip_self', feature: 'payroll' },
] };
const sarana: NavSection = { title: 'Sarana', items: [
  { label: 'Aset', to: 'aset', icon: Boxes, perm: 'asset:read', feature: 'asset' },
  { label: 'Perpustakaan', to: 'perpustakaan', icon: Library, perm: 'library:read', feature: 'library' },
] };
const smk: NavSection = { title: 'SMK', items: [
  { label: 'PPDB', to: 'ppdb', icon: UserPlus, perm: 'ppdb:read', feature: 'ppdb' },
  { label: 'Prakerin', to: 'prakerin', icon: Briefcase, perm: 'internship:read', feature: 'smk' },
...
export const NAV: Record<Role, NavSection[]> = {
  SUPER_ADMIN: [
    { items: [D, { label: 'Lembaga', to: 'lembaga', icon: Building2 }, { label: 'Peran & Izin Platform', to: 'rbac', icon: ShieldCheck }, { label: 'Pengguna Platform', to: 'pengguna', icon: Users }, { label: 'Fitur Global', to: 'fitur', icon: ToggleLeft }, { label: 'Portal Publik', to: 'portal', icon: Globe }, { label: 'Audit Log', to: 'audit', icon: History }, { label: 'Pekerjaan Latar', to: 'jobs', icon: Workflow }] },
    akun,
  ],
  ADMIN_SEKOLAH: [{ items: [D] }, akademik, lms(), kesiswaan, komunikasi, keuangan, sarana, smk, laporan, pengaturan, akun],
  KEPSEK: [{ items: [D, { label: 'Persetujuan', to: 'persetujuan', icon: ClipboardCheck }] }, lms(), { title: 'Akademik', items: akademik.items.slice(0, 7) }, kesiswaan, komunikasi, keuangan, sarana, smk, laporan, { title: 'Pengaturan', items: [{ label: 'Pengguna', to: 'pengguna', icon: Users, perm: 'user:read' }, { label: 'Pelindungan Data', to: 'pdp', icon: Lock }] }, akun],
  WAKEPSEK: [{ items: [D] }, lms(), akademik, kesiswaan, komunikasi, laporan, { title: 'Pengaturan', items: [{ label: 'Pengguna', to: 'pengguna', icon: Users, perm: 'user:read' }] }, akun],
  KAPRODI: [{ items: [D] }, lms(), { title: 'Program Keahlian', items: [{ label: 'Kelas & Rombel', to: 'akademik/kelas', icon: School }, { label: 'Jadwal', to: 'akademik/jadwal', icon: CalendarDays }, { label: 'Prakerin', to: 'prakerin', icon: Briefcase, feature: 'smk' }, { label: 'Uji Kompetensi', to: 'uji-kompetensi', icon: BadgeCheck, feature: 'smk' }, { label: 'Laporan', to: 'laporan', icon: FileBarChart2 }] }, komunikasi, { title: 'Lainnya', items: [{ label: 'Slip Gaji', to: 'payroll/slip', icon: Banknote, feature: 'payroll' }, { label: 'Pengguna', to: 'pengguna', icon: Users }] }, akun],
  GURU: [{ items: [D, { label: 'Kelas Saya', to: 'kelas', icon: School }, { label: 'Jadwal', to: 'jadwal', icon: CalendarDays }] }, lms(), { title: 'Kesiswaan', items: [{ label: 'Izin / Sakit', to: 'absensi/izin', icon: ClipboardCheck }, { label: 'Kedisiplinan', to: 'bk/kedisiplinan', icon: Flag, perm: 'discipline:read', feature: 'bk' }, { label: 'Prestasi', to: 'prestasi', icon: Award }, { label: 'Ekstrakurikuler', to: 'ekskul', icon: Star, feature: 'ekskul' }] }, komunikasi, { title: 'Lainnya', items: [{ label: 'Slip Gaji', to: 'payroll/slip', icon: Banknote, feature: 'payroll' }, { label: 'Absensi Saya', to: 'absensi/staf', icon: CalendarCheck }, { label: 'Perpustakaan', to: 'perpustakaan', icon: Library, feature: 'library' }, { label: 'Aset', to: 'aset', icon: Boxes, feature: 'asset' }, { label: 'Prakerin', to: 'prakerin', icon: Briefcase, feature: 'smk' }, { label: 'Uji Kompetensi', to: 'uji-kompetensi', icon: BadgeCheck, feature: 'smk' }] }, akun],
  STAF: [{ items: [D] }, komunikasi, { title: 'Sarana', items: [{ label: 'Aset', to: 'aset', icon: Boxes }, { label: 'Perpustakaan', to: 'perpustakaan', icon: Library }] }, { title: 'Lainnya', items: [{ label: 'Slip Gaji', to: 'payroll/slip', icon: Banknote, feature: 'payroll' }, { label: 'Absensi Saya', to: 'absensi/staf', icon: CalendarCheck }, { label: 'Pengguna', to: 'pengguna', icon: Users }] }, akun],
  BK: [{ items: [D] }, { title: 'Bimbingan', items: [{ label: 'Konseling', to: 'bk/konseling', icon: HeartHandshake }, { label: 'Kedisiplinan', to: 'bk/kedisiplinan', icon: Flag }, { label: 'Izin / Sakit', to: 'absensi/izin', icon: ClipboardCheck }, { label: 'Absensi', to: 'absensi', icon: CalendarCheck }, { label: 'Nilai', to: 'nilai', icon: GraduationCap }, { label: 'Prestasi', to: 'prestasi', icon: Award }, { label: 'Siswa', to: 'pengguna', icon: Users }, { label: 'Laporan', to: 'laporan', icon: FileBarChart2 }] }, komunikasi, { title: 'Lainnya', items: [{ label: 'Slip Gaji', to: 'payroll/slip', icon: Banknote, feature: 'payroll' }, { label: 'Absensi Saya', to: 'absensi/staf', icon: CalendarCheck }] }, akun],
  KEUANGAN: [{ items: [D] }, keuangan, { title: 'Lainnya', items: [{ label: 'Siswa', to: 'pengguna', icon: Users }, { label: 'Aset', to: 'aset', icon: Boxes }, { label: 'Laporan', to: 'laporan', icon: FileBarChart2 }, { label: 'Absensi Saya', to: 'absensi/staf', icon: CalendarCheck }] }, komunikasi, akun],
  AUDITOR: [{ items: [D] }, laporan, lms(), keuangan, sarana, { title: 'Pengaturan', items: [{ label: 'Pengguna', to: 'pengguna', icon: Users }, { label: 'Peran & Izin', to: 'rbac', icon: ShieldCheck }] }, akun],
  SISWA: [{ items: [D, { label: 'Jadwal', to: 'jadwal', icon: CalendarDays }] }, { title: 'Belajar', items: [{ label: 'Materi', to: 'materi', icon: BookOpen }, { label: 'Tugas', to: 'tugas', icon: ClipboardList }, { label: 'Kuis', to: 'kuis', icon: ListChecks }, { label: 'Ujian', to: 'ujian', icon: PenTool, feature: 'exam' }, { label: 'Nilai', to: 'nilai', icon: GraduationCap }, { label: 'Absensi', to: 'absensi', icon: CalendarCheck }, { label: 'e-Rapor', to: 'rapor', icon: BookMarked, feature: 'rapor' }, { label: 'Peta Konsep', to: 'konsep', icon: Sparkles }] }, { title: 'Sekolah', items: [{ label: 'Pengumuman', to: 'pengumuman', icon: Megaphone }, { label: 'Notifikasi', to: 'notifikasi', icon: Bell }, { label: 'Tagihan', to: 'tagihan', icon: Receipt, feature: 'finance' }, { label: 'Ekstrakurikuler', to: 'ekskul', icon: Star, feature: 'ekskul' }, { label: 'Perpustakaan', to: 'perpustakaan', icon: Library, feature: 'library' }, { label: 'Prakerin', to: 'prakerin', icon: Briefcase, feature: 'smk' }, { label: 'Uji Kompetensi', to: 'uji-kompetensi', icon: BadgeCheck, feature: 'smk' }, { label: 'Data Pribadi', to: 'pdp', icon: Lock }] }, akun],
  WALI_MURID: [{ items: [D] }, { title: 'Anak Saya', items: [{ label: 'Nilai', to: 'nilai', icon: GraduationCap }, { label: 'Absensi', to: 'absensi', icon: CalendarCheck }, { label: 'Tugas', to: 'tugas', icon: ClipboardList }, { label: 'e-Rapor', to: 'rapor', icon: BookMarked, feature: 'rapor' }, { label: 'Izin / Sakit', to: 'absensi/izin', icon: ClipboardCheck }, { label: 'Tagihan', to: 'tagihan', icon: Receipt, feature: 'finance' }, { label: 'Kedisiplinan', to: 'bk/kedisiplinan', icon: Flag, feature: 'bk' }, { label: 'Prestasi', to: 'prestasi', icon: Award }] }, { title: 'Sekolah', items: [{ label: 'Pengumuman', to: 'pengumuman', icon: Megaphone }, { label: 'Notifikasi', to: 'notifikasi', icon: Bell }, { label: 'Data Pribadi', to: 'pdp', icon: Lock }] }, akun],
  CALON_SISWA: [{ items: [D, { label: 'Pendaftaran Saya', to: 'ppdb', icon: UserPlus }, { label: 'Notifikasi', to: 'notifikasi', icon: Bell }] }, akun],
  PEMBIMBING_INDUSTRI: [{ items: [D, { label: 'Siswa Bimbingan', to: 'prakerin', icon: Briefcase }, { label: 'Notifikasi', to: 'notifikasi', icon: Bell }] }, akun],
  PENGUJI_EKSTERNAL: [{ items: [D, { label: 'Uji Kompetensi', to: 'uji-kompetensi', icon: BadgeCheck }, { label: 'Notifikasi', to: 'notifikasi', icon: Bell }] }, akun],
};
