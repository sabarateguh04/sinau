...
Lihat `KONTRIBUSI.md` untuk setup lokal kontributor, `DEPLOY.md` untuk produksi, `PENGUJIAN.md` untuk skenario uji per peran, dan **panduan pengguna** (peran, menu, akun, alur kerja, Alesha) di `http://<host>:4008/panduan` — dilindungi kode akses (`GUIDE_ACCESS_CODE` di `.env`; kosong = kode bawaan yang disepakati tim). Sumbernya `backend/docs/panduan.html`.
